...
At startup, look for `PostgreSQL connection:` in the Jellyfin log to confirm the provider was selected. Database and certificate passwords are removed from this message; successful startup and library use confirm the connection works.
